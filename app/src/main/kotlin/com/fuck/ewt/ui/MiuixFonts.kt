 ...
 *   https://raw.githubusercontent.com/jj-m-j/ewt360-collection/main/fonts/MiSansVF.ttf
 *
 * 下载多源回退（国内可用性）：
...
object MiuixFonts {
    ...
    private val FONT_SOURCES = listOf(
        "https://cdn.jsdelivr.net/gh/jj-m-j/ewt360-collection@main/fonts/$REMOTE_VF_NAME",
        "https://fastly.jsdelivr.net/gh/jj-m-j/ewt360-collection@main/fonts/$REMOTE_VF_NAME",
        "https://gcore.jsdelivr.net/gh/jj-m-j/ewt360-collection@main/fonts/$REMOTE_VF_NAME",
        "https://raw.githubusercontent.com/jj-m-j/ewt360-collection/main/fonts/$REMOTE_VF_NAME",
    )
